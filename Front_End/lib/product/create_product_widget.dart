...
class CreateProductWidget extends StatefulWidget {
  ...
  const CreateProductWidget({Key? key, required this.ownerId}) : super(key: key);
...
class _CreateProductWidgetState extends State<CreateProductWidget> {
 ...
 String getMimeType(String path) {
  ...
  if (path.toLowerCase().endsWith('.jpg') || path.toLowerCase().endsWith('.jpeg')) return 'jpeg';
...
request.fields['discountAmount'] = _model.diciuntamountTextController.text;
  request.fields['recipientType'] = jsonEncode(_model.choiceChipsValues2 ?? []);
            ...
            Padding(
              ...
              child: FlutterFlowIconButton(
                ...
                onPressed: () async {
                   ...
                   context,
                   MaterialPageRoute(builder: (context) => OwnermenuWidget(ownerId: widget.ownerId)),
                   );
                },
              ),
            ),
  ...
  if (pickedFile != null) {
    setState(() {
      selectedImages[0] = File(pickedFile.path);
    });
  }
},
child: selectedImages[0] != null
    ...
    : Padding(
        padding: EdgeInsets.only(left: 20), // 👈 shifts content to the right
        child: Column(
          mainAxisAlignment: MainAxisAlignment.center,
          children: [
            Icon(Icons.add_circle_sharp, color: Color.fromARGB(255, 124, 177, 255), size: 24),
            SizedBox(height: 8),
            Text(
              'Add first photo',
  ...
  if (pickedFile != null) {
    setState(() {
      selectedImages[1] = File(pickedFile.path);
    });
  }
},
child: selectedImages[1] != null
  ...
  if (pickedFile != null) {
    setState(() {
      selectedImages[2] = File(pickedFile.path);
    });
  }
},
child: selectedImages[2] != null
    ...
    : Padding(
        padding: EdgeInsets.only(left: 20), // 👈 adjust as needed
        child: Column(
          mainAxisAlignment: MainAxisAlignment.center,
          children: [
            Icon(Icons.add_circle_sharp, color: Color.fromARGB(255, 124, 177, 255), size: 24),
  ...
  builder: (context, snapshot) {
    if (snapshot.connectionState == ConnectionState.waiting) {
      ...
      return DropdownButtonFormField<String>(
        value: selectedCategoryId ?? categories.first['id'],
        ...
        onChanged: (String? newId) {
          setState(() {
            ...
            selectedCategory = categories.firstWhere((c) => c['id'] == newId)['name'];
          });
        },
        decoration: InputDecoration(
            ...
            borderRadius: BorderRadius.circular(8.0),
                                        ...
                                        FlutterFlowChoiceChips(
                                          ...
                                          selectedChipStyle: ChipStyle(
                                            backgroundColor:
                                                const Color.fromARGB(255, 161, 184, 222),
                                            textStyle:
                                                FlutterFlowTheme.of(context)
                                                    .bodyMedium
                                                    .override(
                                        ...
                                        FlutterFlowChoiceChips(
                                          ...
                                          selectedChipStyle: ChipStyle(
                                            ...
                                            backgroundColor:
                                                const Color.fromARGB(255, 138, 176, 207),
                                            textStyle:
                                                FlutterFlowTheme.of(context)
                                                    .bodyMedium
                                                    .override(
